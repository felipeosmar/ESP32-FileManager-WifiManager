...
OLEDManager::OLEDManager()
    ...
    config.sda_pin = 21;    // Default ESP32 SDA
    config.scl_pin = 22;    // Default ESP32 SCL
    config.rst_pin = -1;    // No reset pin by default
